<template>
  <header id="cc-explore" :class="{'is-active': isActive}" class="cc-global-header">
      <div class="container">
        
        <a class="open-tab" @click="toggleCCExplore" @keypress="toggleCCExplore" aria-label="Explore CC" href="#">
          Explore CC
        </a>
          ...
          <div class="columns padding-bottom-normal">
            <div class="column is-one-quarter">
              ...
              <aside class="donate-section">
                ...
                <a class="button small donate" href="https://us.netdonor.net/page/6650/donate/1?ea.tracking.id=global-navigation-bar">
